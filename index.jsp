        ...
        <div class="con-cont">
            ...
            %>
                 <%
                    while (rsb.next()) {
                 %>
                 <div class="mybook"><a href="sellbook.jsp?b_id=<%= rsb.getString("b_id") %>" class=""><img src="assets/pictures/pic_book/adventure/<%= rsb.getString("b_image") %>" alt="" class="coverbook"></a></div>
                <%
                }
                %>
            </div>
